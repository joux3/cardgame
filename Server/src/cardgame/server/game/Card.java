...
public class Card {
	...
	public enum Rank {
		...
		private static final String[] rankStrings = { "2", "3", "4", "5", "6",
				"7", "8", "9", "t", "j", "q", "k", "a" };
	...
	public static Card fromString(String cardString) {
		return new Card(Rank.fromString(String.valueOf(cardString.charAt(0))),
				Suit.fromString(String.valueOf(cardString.charAt(1))));
	}
	...
	public Image getImage() {
		...
		Image image = null;
		try {
			image = javax.imageio.ImageIO.read(new java.io.File("images/cards/"
					+ toString() + ".gif"));
		} catch (Exception e) {
			try {
	...
	public Color getHitColor() {
		return new Color(0, (int) rank.toString().charAt(0), (int) suit
				.toString().charAt(0));
	}
	...
	public static Card fromColor(Color color) {
		...
		return new Card(Rank
				.fromString(String.valueOf((char) color.getGreen())), Suit
				.fromString(String.valueOf((char) color.getBlue())));
	}
	...
	public static Image getBackImage() {
		if (backImage == null) {
			try {
				backImage = javax.imageio.ImageIO.read(new java.io.File(
						"images/cards/b.gif"));
			} catch (Exception e) {
				try {
					backImage = javax.imageio.ImageIO.read(Card.class
							.getResource("/images/cards/b.gif"));
				} catch (Exception err) {
				}
			}
		}
